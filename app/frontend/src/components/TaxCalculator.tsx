...
export default function TaxCalculator() {
  ...
  const getStandardDeduction = (status: string): number => {
    ...
    return deductions[status as keyof typeof deductions];
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div>
          ...
          <input
            ...
            step="0.01"
            value={customIncome || ''}
            onChange={(e) => setCustomIncome(e.target.value ? parseFloat(e.target.value) : null)}
      ...
      <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
        ...
        <label className="flex items-center gap-2 mb-3">
          <input
            ...
            onChange={(e) => setDeductions({ ...deductions, standard: e.target.checked })}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              onChange={(e) => setDeductions({ ...deductions, business: parseFloat(e.target.value) || 0 })}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setDeductions({ ...deductions, home_office: parseFloat(e.target.value) || 0 })}
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setDeductions({ ...deductions, health_insurance: parseFloat(e.target.value) || 0 })}
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setDeductions({ ...deductions, retirement: parseFloat(e.target.value) || 0 })}
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm"
            />
          </div>
        </div>
