 ...
 *     description: Retrieve all earnings for the authenticated user with optional pagination and filtering
 *     security:
 *       - BearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *     description: Add a new earning entry
 *     security:
 *       - BearerAuth: []
 *     requestBody:
 *       required: true
 ...
 *                 type: string
 *                 format: uuid
 *                 description: ID of the earning platform
 *               amount:
 *                 type: number
 *                 format: decimal
 *                 example: 150.50
 ...
 *     tags:
 *       - Earnings
 *     summary: Delete an earning
 *     description: Remove an earning entry
 *     security:
 *       - BearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     description: Retrieve all expenses with filtering and pagination
 *     security:
 *       - BearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *         schema:
 *           type: string
 *           enum: [supplies, equipment, software, marketing, travel, meals, utilities, other]
 *       - in: query
 *         name: startDate
 *         schema:
 *           type: string
...
// This file contains Swagger/OpenAPI documentation in JSDoc comments
// The comments are parsed by swagger-jsdoc and used to generate the API documentation
// No code execution happens here
